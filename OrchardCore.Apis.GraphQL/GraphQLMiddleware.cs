...
namespace OrchardCore.Apis.GraphQL
{
    public class GraphQLMiddleware
    {
        ...
        public async Task Invoke(HttpContext context, IAuthorizationService authorizationService,
            IAuthenticationService authenticationService, ISchemaFactory schemaService,
            ...
            IContentManager _contentManager)
        {
            ...
            else
            {
                ...
                if (authorized)
                {
                    await ExecuteAsync(context, schemaService, _authorizationService, _contentDefinitionManager, _contentManager);
                }
                else
                {
            ...
            IContentManager _contentManager)
        {
            ...
            //=============================================
            await AuthorityContent.AuthorityContents.FilterResult(_authorizationService,_contentDefinitionManager,
                _contentManager,result, context);
            //=============================================
